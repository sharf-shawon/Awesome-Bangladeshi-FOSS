...
def build_pr_body(month_tag: str, added_entries: list[dict[str, str]]) -> str:
    lines = [
        f"## Summary",
        "",
        ...
        "- Added suggested repositories for manual maintainer review.",
        "",
        "## Suggested additions",
        "",
    ]
...
def main() -> int:
    ...
    pr_body = build_pr_body(month_tag, added_entries)
